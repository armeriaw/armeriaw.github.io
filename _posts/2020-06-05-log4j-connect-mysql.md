---
layout: post
title: log4j-connect-mysql
postTitle: log4j日志过滤：连接MySQL数据库
categories: [Java, Software Construction, MySQL]
description: 软件构造第10次博客
keywords: Java, Software Construction, log4j, MySQL, JDBC
published: true
mathjax: false
typora-root-url: ..
---
